...
const StudentIssue = () => {
  ...
  // Fetch student issues from backend
  useEffect(() => {
    axios
      .get("http://localhost:2004/student-contact/all")
  ...
  const handleResponseSubmit = () => {
    const updatedIssue = { ...selectedIssue, status: "Resolved" };

    // Send email using backend endpoint
    axios
      .post("http://localhost:2004/student-contact/send-email", updatedIssue)
      .then(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="min-h-screen bg-gray-100 p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Student Issues List</h1>
